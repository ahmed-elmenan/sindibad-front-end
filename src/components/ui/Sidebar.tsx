    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full -mt-[4px]",
            // Removed any rounded corner classes
            className
          )}
          {...props}
        >
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "!mr-0 relative flex w-full flex-1 flex-col min-h-screen",
        "bg-[#111111] dark:bg-[#0b0607]",
