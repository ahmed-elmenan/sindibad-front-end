      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-slate-300 max-w-3xl mx-auto">
            SindiBad is transforming education across the region with innovative
            learning solutions and community engagement.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <div className="text-gray-600 dark:text-slate-300 text-sm uppercase tracking-wide">
                {stat.label}
              </div>
            </motion.div>
          ))}
